    ...
    return new ObjectNode(
      {
        ...
        get looping() {
          return new FieldNode(
            schema.GiphyGIFImageDataLooping,
            undefined,
            true
          );
        }
  ...
  get GiphyGIFImageDataFixedHeightStill() {
    return new ObjectNode(
      ...
      },
      {
        ...
        extension: ((extensions as any) || {}).GiphyGIFImageDataFixedHeightStill
      }
    );
  },
  ...
  get GiphyGIFImageDataFixedHeightSmall() {
    return new ObjectNode(
      ...
      },
      {
        ...
        extension: ((extensions as any) || {}).GiphyGIFImageDataFixedHeightSmall
      }
    );
  },
